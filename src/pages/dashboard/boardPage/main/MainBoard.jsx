    ...
    return (
      <div className={`dashboard-board__popup ${className}`}>
        <div
          ...
          onClick={e => {
            e.target.parentNode.classList.remove('dashboard-board__popup_active');
          }}
        >
        ...
        <div className="dashboard-board__popup-list">
          ...
          <Link to={ROUTES.DASHBOARD_BOARDS_EDIT} className="dashboard-board__popup-item">
            <MdSettings />
            Edit board settings
          </Link>
          <div className="dashboard-board__popup-item">
          ...
          <Link to={ROUTES.DASHBOARD_POSTS} className="dashboard-board__popup-item">
            <MdModeComment />
            View posts
          </Link>
        </div>
          ...
          <div
            ...
            onClick={e => {
              if (e.target.classList.contains('dashboard-board__more')) {
                e.target.nextSibling.classList.toggle('dashboard-board__popup_active');
              }
            }}
          >
