  ...
  return (
    <>
      <div className="dashboard__path">
        <Helmet>
          <title>Dashboard User Segments Add - PRONY</title>
        </Helmet>
        ...
        <Link to={ROUTES.DASHBOARD_USERS_SEGMENTS}>Add user segment</Link>
      </div>
      <div className="dashboard__main">
        <div className="dashboard__title">Add user segment</div>
      </div>
...
export default UserSegmebtsAdd;
