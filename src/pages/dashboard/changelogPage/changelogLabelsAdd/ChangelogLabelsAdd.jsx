  ...
  return (
    <>
      <div className="dashboard__path">
        ...
        <Link to={ROUTES.DASHBOARD_CHANGELOG_LABELS_ADD}>Adds new changelog label</Link>
      </div>
      <div className="dashboard__main">
        <div className="dashboard__title">Adds new changelog label</div>
      </div>
...
export default ChangelogLabelsAdd;
